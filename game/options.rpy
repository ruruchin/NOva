...
define config.name = _("Zero Keep Out")
...
define build.name = "Zero Keep Out"
...
define config.window_show_transition = Dissolve(1.2)
define config.window_hide_transition = Dissolve(1.2)
...
define config.save_directory = "BadSingular-1708368448"
