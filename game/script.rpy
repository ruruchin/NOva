...
label scnd_chapter:
    ...
    effi"Всё у тебя так хорошо, что даже не замечаешь, как эта душнота бьёт по мне. Ты даже ничего не сможешь изменить. Мудак, который думает лишь о себе. Я вынуждена ОТВЕЧАТЬ на твои вопросы?"
